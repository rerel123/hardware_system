...
<p class="mb-0">Manage products inside each order</p>
</div>
...
<i class="bi bi-list-check"></i> Order Detail Form
</h5>
...
return `
<button class="btn btn-warning btn-sm editBtn" data-id="${data.OrderDetailID}">
<i class="bi bi-pencil"></i>
</button>

<button class="btn btn-danger btn-sm deleteBtn" data-id="${data.OrderDetailID}">
...
$('#OrderDetailID').val(d.OrderDetailID);
$('[name="OrderID"]').val(d.OrderID);
$('[name="ProductID"]').val(d.ProductID);
$('[name="Quantity"]').val(d.Quantity);
