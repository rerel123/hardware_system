...
<p class="mb-0">Manage all customer orders</p>
</div>
...
<i class="bi bi-cart-check"></i> Order Form
</h5>
...
<input type="number" name="ShipperID" class="form-control" required>
</div>
...
return `
<button class="btn btn-warning btn-sm editBtn" data-id="${data.OrderID}">
<i class="bi bi-pencil"></i>
</button>

<button class="btn btn-danger btn-sm deleteBtn" data-id="${data.OrderID}">
...
$('[name="OrderDate"]').val(o.OrderDate);
